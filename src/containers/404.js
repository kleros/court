    ...
    <StyledDiv Web3={Web3}>
      ...
      <StyledInfoDiv className="quaternary-background theme-background">
        ...
        <StyledMessageLine3 className="ternary-color theme-color">
          {Web3
            ? "Please make sure you have your wallet unlocked on Mainnet, Kovan, Sokol or xDAI. If you don't have a wallet, we recommend you install MetaMask on desktop and Trust on mobile."

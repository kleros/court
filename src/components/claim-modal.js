...
// Snapshot CIDs live in src/assets/snapshots.json (also published at court.kleros.io/snapshots.json,
// consumed by klerosboard and proof-of-humanity-v2-web). The array index of each snapshot is the
// on-chain `week` argument to MerkleRedeem.claimWeek, so the order in snapshots.json must never change.
